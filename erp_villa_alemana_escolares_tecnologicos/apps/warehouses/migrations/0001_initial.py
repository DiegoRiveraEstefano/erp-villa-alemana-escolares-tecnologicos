    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(help_text='The address of the warehouse.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='warehouses', to='addresses.address', verbose_name='Warehouse Address')),
            ],
            options={
