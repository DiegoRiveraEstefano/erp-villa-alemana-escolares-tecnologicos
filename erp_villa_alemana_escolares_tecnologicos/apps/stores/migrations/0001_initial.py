    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(help_text='The address of the store.', on_delete=django.db.models.deletion.CASCADE, related_name='stores', to='addresses.address', verbose_name='Store Address')),
