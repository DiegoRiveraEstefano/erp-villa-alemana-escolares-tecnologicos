...
# erp_villa_alemana_escolares_tecnologicos/
APPS_DIR = BASE_DIR / "erp_villa_alemana_escolares_tecnologicos"
env = environ.Env()
...
LOCAL_APPS = [
    ...
    "erp_villa_alemana_escolares_tecnologicos.apps.employees",
    "erp_villa_alemana_escolares_tecnologicos.apps.products",
    "erp_villa_alemana_escolares_tecnologicos.apps.warehouses",
    "erp_villa_alemana_escolares_tecnologicos.apps.stores",
    "erp_villa_alemana_escolares_tecnologicos.apps.sales",
]
...
ADMINS = [("""Diego Rivera""", "diego-rivera@example.com")]
